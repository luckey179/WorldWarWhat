...

{
	...
	public class HordeDay1 : MonoBehaviour {
		...
		public GameObject Catago1;
		public GameObject Catago2;
		public GameObject Catago3;
		public GameObject Catago4;
		...
		void Awake ()
		{
			...
			text = GameObject.Find("MedievalDayTime").GetComponent<Text>();
		}
		...
		void Update ()
		{
			...
			if (Day >= 7) 
			{
				...
				Catago1.SetActive (true);
				Catago2.SetActive (true);
				Catago3.SetActive (true);
				Catago4.SetActive (true);
			}
			...
			if (Day >= 10) 
			{
				...
				Catago1.SetActive (false);
				Catago2.SetActive (false);
				Catago3.SetActive (false);
				Catago4.SetActive (false);
